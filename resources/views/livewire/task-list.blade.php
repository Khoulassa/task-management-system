                                                                ...
                                                                <td class="px-4 py-1 whitespace-nowrap text-left">
                                                                    ...
                                                                    <div class="flex justify-end">
                                                                        ...
                                                                        <x-jet-button
                                                                            ...
                                                                            <svg class="w-4 h-4 inline-block mr-2" fill="currentColor" viewBox="0 0 20 20">
                                                                                <path d="M9 2a1 1 0 00-1 1v1H5a1 1 0 000 2h10a1 1 0 100-2h-3V3a1 1 0 00-1-1H9zM4 7a1 1 0 000 2v8a2 2 0 002 2h8a2 2 0 002-2V9a1 1 0 100-2H4zm4 2a1 1 0 112 0v6a1 1 0 11-2 0V9zm4 0a1 1 0 112 0v6a1 1 0 11-2 0V9z" />
                                                                            </svg>
                                                                        </x-jet-button>
                                                                    </div>
